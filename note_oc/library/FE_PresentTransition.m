...
@interface FE_PresentTransition ()

@property (nonatomic, assign) FEPresentTransitionType type;

@end


@implementation FE_PresentTransition
...
- (NSTimeInterval)transitionDuration:(id<UIViewControllerContextTransitioning>)transitionContext {
    return  _type == FEPresentTransitionDismiss ? 0.25 : 0.5;
}

- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    
    switch (_type) {
        case FEPresentTransitionDismiss:{
            [self dismissAnimation:transitionContext];
        }
            
            break;
           case FEPresentTransitionPresent:
        {
...
- (void)presentAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    [containerView insertSubview:toVC.view aboveSubview:tempView];
